...
export default function Login() {
  ...
  return (
    <main className="h-screen w-full flex items-center justify-center">
      <div className="md:w-[23%] w-full bg-black md:rounded-r-lg rounded-lg p-6 flex flex-col justify-center items-center relative" style={{ height: '600px', backgroundColor: '#1E1E1E' }}>
        <h1 className={`text-4xl pb-10 font-extrabold text-center text-white absolute top-10`}>Login</h1>
